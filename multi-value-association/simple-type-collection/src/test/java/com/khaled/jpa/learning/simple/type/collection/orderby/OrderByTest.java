...
public class OrderByTest {
    ...
    static void generateDatabase() {
        emf = Persistence.createEntityManagerFactory("setupUCollectionElementOrderBy");
        em = emf.createEntityManager();
    }

    @BeforeEach
    void createPersistenceContext() {
        emf = Persistence.createEntityManagerFactory("readyUCollectionElementOrderBy");
        em = emf.createEntityManager();
    }
    ...
    void createUserIntrestTest() {
        ...
        var expected = Arrays.asList(JAVA, JAKARTAEE);
        ...
        reversed.sort(Comparator.<String>naturalOrder().reversed());
        assertNotEquals(
                reversed,
                actualIntrest
        );
    ...
    void insertAtTheStartTest() {
        ...
        var actualIntrest = user.getIntrests();
        var expected = Arrays.asList(HELIDON, JAVA);
        expected.sort(Comparator.naturalOrder());
        assertEquals(expected, actualIntrest);
        var reversed = expected;
        reversed.sort(Comparator.<String>naturalOrder().reversed());
        assertNotEquals(reversed, actualIntrest);
    }
    ...
    void insertInTheMiddleTest() {
        ...
        var actualIntrest = user.getIntrests();
        var expected = Arrays.asList(HELIDON, JAVA, MICROPROFILE );
        expected.sort(Comparator.naturalOrder());
        assertEquals(expected, actualIntrest);
        var reversed = expected;
        reversed.sort(Comparator.<String>naturalOrder().reversed());
