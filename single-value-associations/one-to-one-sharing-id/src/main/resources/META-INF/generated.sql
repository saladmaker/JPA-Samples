...
CREATE TABLE POSTDETAIL (CONTENT CLOB(64000), POST_ID BIGINT NOT NULL,
 PRIMARY KEY (POST_ID))

ALTER TABLE POSTDETAIL ADD CONSTRAINT POSTDETAIL_POST_ID FOREIGN KEY (POST_ID)
 REFERENCES POST (ID)
